        ...
        final StringRequest request = new StringRequest(Request.Method.GET, "https://api.cominatyou.com/silverpoint/updates", rsp -> {
            try {
                ...
                if (response.getInt("versionCode") > BuildConfig.VERSION_CODE && !response.getBoolean("breaking")) {
                    ...
                    binding.startWorkerLayout.setEnabled(false);
                    ...
                    final View[] buttonElements = {binding.startWorkerDescription, binding.testWorkerLayout, binding.debugLayout, binding.testWorkerDescription, binding.debugDescription};
